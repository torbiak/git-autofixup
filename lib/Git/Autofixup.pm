...
If cpan is available, run C<cpan Git::Autofixup>. Otherwise, copy git-autofixup.pm to a directory in PATH, rename it to git-autofixup, and ensure it has execute permissions.
